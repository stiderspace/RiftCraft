...
public class ItemHellfireHelmet extends ItemArmor
{
	
    public ItemHellfireHelmet(String unlocalizedName, ArmorMaterial material, String textureName, int armorType) 
    {

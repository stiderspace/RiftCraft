...
public class ChunkProviderTesting implements IChunkProvider
{
    ...
    public ChunkProviderTesting(World world, long seed, boolean mapFeaturesEnabled)
    {
        LogHelper.log(Level.INFO, "Loading Chunk Provider for dmension.");
        this.worldObj = world;
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    blocks[j3 += short1] = ModBlocks.CrystalBlock;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
    ...
    {
        LogHelper.log(Level.INFO, "Replacing block for biome.");
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        this.rand.setSeed((long) par2 * i1 + (long) par3 * j1 ^ rand.nextLong());
        boolean flag = false;

...
public class ChunkProviderSubzero implements IChunkProvider
{
    ...
    public ChunkProviderSubzero(World p_i2006_1_, long p_i2006_2_, boolean p_i2006_4_)
    {
                    ...
                    for (int l2 = 0; l2 < 8; ++l2)
                    {
                        ...
                        for (int i3 = 0; i3 < 4; ++i3)
                        {
                            ...
                            for (int k3 = 0; k3 < 4; ++k3)
                            {
                                if ((d15 += d16) > 0.0D)
                                {
                                    p_147424_3_[j3 += short1] = ModBlocks.SubzeroIce;
                                }
                                else if (k2 * 8 + l2 < b0)
                                {
    ...
    public void populate(IChunkProvider p_73153_1_, int p_73153_2_, int p_73153_3_)
    {
            ...
            && TerrainGen.populate(p_73153_1_, worldObj, rand, p_73153_2_, p_73153_3_, flag, LAKE))
        {
            ...
            (new WorldGenLakes(Blocks.packed_ice)).generate(this.worldObj, this.rand, k1, l1, i2);
        }

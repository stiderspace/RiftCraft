package spaceCoder.riftcraft.dimensions.worldChunkManager;
...
import spaceCoder.riftcraft.dimensions.worldGenLayer.LightForestGenLayer;
...
public class WorldChunkManagerForest extends WorldChunkManager {
    ...
    public WorldChunkManagerForest(long seed, WorldType worldType)
    {
        ...
        GenLayer[] agenlayer = LightForestGenLayer.makeTheWorld(rand.nextLong(), worldType);
        agenlayer = getModdedBiomeGenerators(worldType, rand.nextLong(), agenlayer);
    ...
    {
        this(rand.nextLong(), world.getWorldInfo().getTerrainType());
    }

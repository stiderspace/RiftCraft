...
public class RenderItemRiftMachine implements IItemRenderer
{
    private IModelCustom model;
    
    public RenderItemRiftMachine()
    {
        model = AdvancedModelLoader.loadModel(Models.RIFTMACHINE);
    }
    ...
    public void renderItem(ItemRenderType itemRenderType, ItemStack itemStack, Object... data)
    {
        ...
        private void render(float xPos, float yPos, float zPos, float scale)
        {
            ...
            FMLClientHandler.instance().getClient().renderEngine.bindTexture(Textures.MODEL_RIFTMACHINE);

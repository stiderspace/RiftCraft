...
public class Models
{
    ...
    public static final ResourceLocation RIFTMACHINE= ResourceLocationHelper.getResourceLocation(MODEL_LOCATION + "RiftMachien_Base.obj");
    public static final ResourceLocation RIFTMACHINERING = ResourceLocationHelper.getResourceLocation(MODEL_LOCATION + "RiftMachien_Ring.obj");
    public static final ResourceLocation RIFTMACHINESUPORT = ResourceLocationHelper.getResourceLocation(MODEL_LOCATION + "RiftMachien_suport.obj");
}
